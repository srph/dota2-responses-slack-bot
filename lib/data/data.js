...
const UNITS_URL = 'http://dota2.gamepedia.com/api.php?action=query&list=categorymembers&cmlimit=500%27%20%27&cmprop=title&format=json&cmtitle=Category:Lists_of_responses';
const RESPONSES_BASE_URL = 'http://dota2.gamepedia.com'; // e.g., http://dota2.gamepedia.com/abaddon_responses
const FILENAME = 'responses.js';

(async function() {
  try {
    const announcers$ = await axios.get(UNITS_URL);
